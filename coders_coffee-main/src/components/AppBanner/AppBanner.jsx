    ...
    <div style={BannerStyle} className="sm:min-h-[400px] sm:flex sm:justify-end sm:items-center rounded-xl" >
      <div className="">
        <div className="space-y-6  max-w-xl mx-auto">
          ...
          className="text-center text-sm sm:px-20">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis nobis amet numquam porro vero magnam.</motion.p>
